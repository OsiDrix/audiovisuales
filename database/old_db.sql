...
INSERT INTO `audiovisual-utesa`.`user`
(id, username, password, role_id, name, surname, birthday, email, phone, schedule_id, active, created_at, updated_at)
VALUES('0', 'admin', '$2b$10$n1UWsoXitVAyMBfbafPfM.c6C6TTClaEwSRHFYV7rGpFZyQfsIFgu', '0', 'admin_name', 'admin_surname', '2022-12-25', 'admin@admin.com', '+18098098091', NULL, 1, '2022-12-07 07:44:36.000', '2022-12-07 08:01:35.000');

INSERT INTO `audiovisual-utesa`.`user`
(id, username, password, role_id, name, surname, birthday, email, phone, schedule_

INSERT INTO `audiovisual-utesa`.`role`
(id, `role`, created_at, updated_at)
VALUES('0', 'Admin', '2022-12-03 21:17:26.000', '2022-12-03 21:17:26.000');
INSERT INTO `audiovisual-utesa`.`role`
(id, `role`, created_at, updated_at)
VALUES('1', 'Auxiliar', '2022-12-03 21:17:26.000', '2022-12-03 21:17:26.000');

INSERT INTO `audiovisual-utesa`.`user`
(id, username, password, role_id, name, surname, birthday, email, phone, schedule_id, active, created_at, updated_at)
VALUES('3d68bfc3-cf90-4', 'Ivan_Test', '$2b$10$D5WTpuhI4Un7mu4iGJgeYOyxd3UFXosNpM0ZA8.DQ9Qgr6DGRrRjW', '1', 'Ivan_Test', 'Iavn_Test', '2022-12-01', 'ivanmendoza2011@hotmail.com', '+18097520141', NULL, 1, '2022-12-21 13:45:10.000', '2022-12-21 13:45:10.000');